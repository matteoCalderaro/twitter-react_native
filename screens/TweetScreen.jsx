    ...
    <View style={styles.container}>
      <View style={styles.profileContainer}>
        <TouchableOpacity style={styles.flexRow}>
          ...
          />
          <View>
            <Text style={styles.tweetName}>Matteo Calderaro</Text>
            <Text style={styles.tweetHandle}>@matteocalderaro</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
      ...
      <View style={styles.tweetContentContainer}>
        <Text style={styles.tweetContent}>
          ...
          voluptate beatae exercitationem eveniet quasi, reprehenderit atque
          temporibus ab nobis dicta?
        </Text>
      </View>
